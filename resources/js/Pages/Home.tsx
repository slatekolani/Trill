                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                ...
                                <a href="tel:+255718694863" className="inline-flex items-center gap-3 text-navy-800 font-semibold hover:text-gold-600 transition-colors duration-300">
            ...
            <section className="py-20 bg-gradient-to-r from-gold-600 to-gold-500 relative overflow-hidden">
                ...
                <div className="relative max-w-4xl mx-auto px-4 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <a href="tel:+255718694863" className="inline-flex items-center justify-center gap-2 border-2 border-navy-950 text-navy-950 hover:bg-navy-950 hover:text-white font-semibold px-10 py-4 rounded-sm transition-all duration-300 tracking-wide uppercase text-sm">
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                            </svg>
                            +255 7１８ ６９４ ８６３
