                    ...
                    <div className="grid lg:grid-cols-3 gap-16">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-gray-50 border border-gray-100 rounded-sm p-7">
                                ...
                                <a href="tel:+255738600670" className="flex items-center gap-3 text-gray-600 hover:text-gold-600 transition-colors mb-3">
                                    ...
                                    <span className="text-sm">+255 738 600 670</span>
                                </a>
